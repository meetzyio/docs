...
<Warning>
  Si prefieres control total desde el inicio, haz clic en el enlace **"or start from scratch"** debajo del campo de texto. Esto omite la generación automática y te lleva directamente al Editor Avanzado con una configuración en blanco.
</Warning>
...
| Volver atrás | Haz clic en la flecha superior izquierda |
