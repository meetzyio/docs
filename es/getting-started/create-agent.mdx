...
Al hacer clic en **"Create Agent"** o acceder al Editor Avanzado sin un agente existente, Meetzy te recibe con una pantalla de creación completamente rediseñada, pensada para que empieces describiendo tu idea en lugar de rellenar formularios:

- **Fondo Animado WebGL**: Ondas fluidas renderizadas en un `<canvas>` que responden sutilmente al cursor, creando una experiencia inmersiva y moderna
- **Campo de Texto Inteligente**: Un textarea central con bordes gradientes dinámicos que reaccionan al foco y al contenido introducido
- **Logo Centrado**: El logo de Meetzy se posiciona en la parte superior y se adapta automáticamente a modo claro y oscuro
- **Navegación Intuitiva**: Un botón de regreso (flecha) en la esquina superior izquierda te permite volver a la lista de agentes en cualquier momento
- **Indicadores Visuales**: Un botón de envío aparece dinámicamente en cuanto empiezas a escribir, junto con un hint que indica el atajo `Enter` para generar
...
<Steps>
  <Step title="Describe tu agente">
    Escribe en el campo central una descripción de qué debe hacer tu agente. Por ejemplo:
    ...
    El campo se enfoca automáticamente al cargar la pantalla, así que puedes empezar a escribir de inmediato.
  </Step>
  
  <Step title="Genera la configuración">
    Presiona **Enter** o haz clic en el botón de envío (icono de avión de papel) que aparece en la esquina inferior derecha del campo de texto en cuanto detecta contenido.
  ...
  <Step title="Continúa en el Editor Avanzado">
    Tras la generación, la pantalla se cierra con una animación de salida y aterrizas directamente en el Editor Avanzado con tu agente ya configurado, listo para refinar cualquier detalle.
  </Step>
</Steps>
