...
<Info>
No necesitas cerrar el reproductor ni volver a la tabla para marcar una llamada como revisada, escribir una nota de auditoría o gestionar sus etiquetas: todo está disponible en el propio modal de grabación, y los cambios se guardan sobre la misma llamada que ves en la tabla de fondo.
</Info>

En la parte inferior del modal encontrarás los controles de revisión y etiquetas:
