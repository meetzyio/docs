...
<Info>
**Disponibilidad de la nueva vista mejorada de llamadas**: la vista renovada del historial de llamadas ya está disponible para todas las cuentas en la ruta `/calls-v2`, accesible directamente desde **Calls** en el menú principal. Esta misma página documenta en detalle esa vista avanzada actualizada; consulta especialmente la sección [Vista General de la Interfaz](#vista-general-de-la-interfaz) para un resumen visual de todas sus funcionalidades: columnas configurables, columnas dinámicas, vistas guardadas, métricas reales de latencia, reproductor de grabaciones con forma de onda, revisión/auditoría, detección de llamadas sospechosas y exportación mejorada a Excel.
</Info>
...
<Info>
En ambos casos, la exportación es **configurable**: el archivo Excel generado respeta exactamente las columnas visibles y su orden actual en la tabla, incluyendo cualquier columna dinámica de Input u Output que