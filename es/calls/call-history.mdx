...
| ✅ **Columna de Revisión/Auditoría** | Marca llamadas como revisadas y añade notas de auditoría, con la columna siempre visible a la derecha |
...
| **Reviewed** | Estado de revisión/auditoría de la llamada, con nota opcional. Anclada a la derecha | Sí |
...
<Steps>
  <Step title="Marcar como Revisada">
...
| 🎧 **Play Recording** | Abrir el reproductor de grabación con forma de onda y transcripción enriquecida |
...
<Tabs>
  <Tab title="Exportación Completa">
  ...
  <Tab title="Exportación Selectiva">
...
<Steps>
  <Step title="¿Qué es ese banner ámbar que aparece encima de la tabla?">
  ...
  <Step title="¿Por qué el filtro de llamadas sospechosas muestra menos resultados de los que esperaba?">
  ...
  <Step title="¿La nota de auditoría se guarda automáticamente?">
  ...
  <Step title="¿Puedo exportar solo las llamadas que ya revisé?">
  ...
  <Step title="¿Por qué las columnas Reviewed y Actions siempre aparecen a la derecha, aunque las reordene?">
