...
<Info>
El Editor Avanzado incluye ahora un **selector de agentes integrado** que permite cambiar entre diferentes agentes sin perder el contexto de trabajo, junto con un sistema completo de control de versiones Git y herramientas de testing mejoradas para garantizar la calidad de tus agentes en producción con colaboración en tiempo real.
</Info>
...
El selector de agentes optimiza significativamente el flujo de trabajo profesional:
...
<Steps>
  <Step title="Selección de Agente">
    Utiliza el selector de agentes para cambiar al agente deseado o crear uno nuevo. El sistema detecta cambios no guardados automáticamente.
  </Step>
...
<Tabs>
  <Tab title="Desarrollo Individual">
    **Flujo de trabajo personal optimizado:**
    - Usa el selector de agentes para organizar tu trabajo por proyecto o cliente
