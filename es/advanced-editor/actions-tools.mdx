...
<Tabs>
  ...
  <Tab title="Francés">
    ```text
    Se utilise pour transférer l'appel à une personne dans les cas indiqués :
...
<Tabs>
  ...
  <Tab title="Inglés">
    ...
    - "Lo sentimos, pero en este momento no podemos..."
    - "La persona que está llamando no está disponible"
    - "Ha llegado al buzón de voz de..."
    - "Gracias por llamar, actualmente estamos..."
    - "Su llamada es importante para nosotros, espere..."
    - "No podemos tomar su llamada ahora mismo"
    - "Deje su mensaje al sonido del pitido"
    - "Este es el contestador automático de..."
  ...
  <Tab title="Francés">
    ...
    - "Lo sentimos, pero en este momento..."
    - "La persona que está llamando no está disponible"
    - "Ha contactado el buzón de voz de..."
    - "Gracias por llamar, actualmente estamos..."
    - "Bienvenido al contestador de..."
