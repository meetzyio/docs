...
| **Ver todas las llamadas** | Botón "View all" en la pestaña Calls | Abre la sección Calls filtrada por este agente en una nueva pestaña |
...
- **Pausar múltiples agentes**: Para m