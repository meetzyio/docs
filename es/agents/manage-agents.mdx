...
| **Clone** | Administradores y usuarios con rol adecuado | Inicia el flujo de clonación en dos pasos, en un modal dedicado |
...
<Steps>
  ...
  <Step title="Personalizar">
    Una vez creado, el nuevo agente queda seleccionado automáticamente en el panel de detalle para que puedas editarlo según tus necesidades específicas
  </Step>
</Steps>
...
| **Clone** | Botón "Clone" (pestaña Overview) | Abre el modal de clonación en dos pasos |
...
- **Phone Health**: Estado de números telefónicos asignados, visible como un chip de color en cada fila de la lista (cargado bajo demanda), filtrable mediante el interruptor **Phone health** y accesible en detalle desde la pestaña Overview o desde el modal correspondiente
