...
<CardGroup cols={2}>
  <Card title="Crear una Llamada" icon="phone" href="/es/api-reference/endpoint/create">
    Aprende cómo iniciar llamadas via API.
  </Card>
  <Card title="Crear una Campaña" icon="megaphone" href="/es/api-reference/endpoint/campaign">
    Lanza campañas de llamadas salientes desde una lista de contactos.
  </Card>
  <Card title="Obtener Detalles de Llamada" icon="info-circle" href="/es/api-reference/endpoint/get">
    Recupera información detallada de llamadas.
  </Card>
  <Card title="Listar Llamadas" icon="list" href="/es/api-reference/endpoint/list">
