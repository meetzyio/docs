...
<CardGroup cols={2}>
  ...
  <Card title="Quality Assurance" icon="check-double">
    Listen to recordings, check transcriptions, and mark each call Pending/OK/KO to build a fast, keyboard-driven QA workflow.
  </Card>
...
<Info>
There is no dedicated shortcut for the verdict control — use the on-screen Pending/OK/KO buttons in the modal. This keeps the verdict a deliberate click rather than something that could be triggered accidentally while navigating between calls.
</Info>
