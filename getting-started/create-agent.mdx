...
### Using the Creation Overlay

When you create a new agent, you'll see a beautiful overlay with an animated wave background. This is your starting point for rapid agent creation.
...
<Steps>
  ...
  <Step title="Generate Your Agent">
    Press **Enter** or click the send button (arrow icon) to generate your agent. Meetzy's AI will automatically:
...
- **Keyboard Shortcuts**: Press `Enter` to generate or `Escape` to start from scratch
- **Theme Aware**: Automatically matches your light/dark theme preference
- **Mobile Friendly**: Works perfectly on mobile devices

<Info>
  You can always skip the prompt-first creation by clicking "or start from scratch" to open the Advanced Editor directly.
</Info>
