...
<Steps>
  <Step title="Provider Authentication">
    ...
    - Obtain necessary API credentials and scopes
  </Step>
  <Step title="Calendar Selection">
    Choose which calendars to check for availability and where to create new events.
  </Step>
  <Step title="Availability Rules">
    Define working hours, buffer times, and blackout dates for appointment booking.
  </Step>
  <Step title="Booking Confirmation">
    Configure confirmation messages, email notifications, and calendar invitations sent after a successful booking.
  </Step>
</Steps>