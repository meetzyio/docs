...
<Steps>
  ...
  <Step title="Panels Disappear">
    The left configuration panel and the right panel (Copilot, Playground, Tests, Changes) smoothly collapse out of view.
  </Step>
...
<Info>
Focus Mode and the expandable right panel work great together: use Focus Mode when you need to write without distractions, and expand the right panel when you need to read long Copilot answers, Playground transcripts, or Changes diffs in detail.
</Info>
